...
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/user_info_money.lua)"

echo ""
echo "user_info_vip.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/user_info_vip.lua)"
...
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/group_search.lua)"

echo ""
echo "group_quit"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/group_quit.lua)"

echo ""
echo "group_users.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/group_users.lua)"

echo ""
echo "group_users_channel.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/group_users_channel.lua)"

echo ""
echo "group_users_ready.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/group_users_ready.lua)"

# 

echo ""
echo "fishjoy_ready.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/fishjoy_ready.lua)"

echo ""
echo "fishjoy_shot.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/fishjoy_shot.lua)"

echo ""
echo "fishjoy_blast.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/fishjoy_blast.lua)"

echo ""
echo "fishjoy_bullet.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/fishjoy_bullet.lua)"

echo ""
echo "fishjoy_switch.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/fishjoy_switch.lua)"

echo ""
echo "fishjoy_tool.lua"
/root/my/redis/redis-3.2.6/src/redis-cli -a 123456 script load "$(cat /root/my/git/speedt/g2/assets/redis/fishjoy_tool.lua)"
